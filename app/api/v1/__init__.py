...
from app.api.v1 import auth, depots, driver, drivers, fleet, geocode, locations, metrics, optimize, routes, users
...
router.include_router(drivers.router, tags=["Drivers"], **_protected)
...
router.include_router(geocode.router, tags=["Geocoding"], **_protected)
